 ...
 */
export function getPortalDeploymentType(portal: __esri.Portal): "ago" | "enterprise" | "enterpriseKubernetes" | "unknown" {
...
//////////////////////////////////////
  ...
  // _getPortalHelpUrl
  function _getPortalHelpUrl(deploymentType: "enterprise" | "enterpriseKubernetes", portal: __esri.Portal): string {
  ...
  function _usePortalSSL(portal: __esri.Portal): boolean {
    ...
    httpPort !== 80 &&
    httpsPort !== 443 && location.protocol === "https:");
  }

...
class CompatibilityCheckerUT {
  init() {
    suite("CompatibilityChecker", () => {
      const compatibilityChecker =
        new CompatibilityChecker.CompatibilityChecker({
          ...
          requirementsMessages: {
            AttachmentViewer:
              "This app requires a feature layer with attachments",
            ChartViewer:
              "This app requires a map with at least one chart configured",
            ImageryViewer: "This app requires an imagery layer",
            InteractiveLegend:
              "This app requires a feature layer with a supported drawing style",
            Nearby: "This app requires a feature layer with pop-up enabled",
            ZoneLookup:
              "This app requires a Polygon feature layer with pop-up enabled",
          },
        });
      ...
      suite(
        "WebMap: https://catsqa.mapsdevext.arcgis.com/home/item.html?id=20ddfc08d0a24dcd8d10cb7c4aefc01e",
        () => {
          test("checkAllTemplates", async () => {
            const result: Map<CompatibilityChecker.EAppTemplateType, string> =
              await compatibilityChecker.checkAllTemplates(
                new WebMap({
                  portalItem: {
                    id: "20ddfc08d0a24dcd8d10cb7c4aefc01e",
                    portal: new Portal({
                      url: "https://catsqa.mapsdevext.arcgis.com/",
                    }),
                  },
                })
              );
            ...
            [
              ...
              [
                CompatibilityChecker.EAppTemplateType.CategoryGallery,
              ...
              [
                CompatibilityChecker.EAppTemplateType.ImageryApp,
                "This app requires an imagery layer",
              ],
              [CompatibilityChecker.EAppTemplateType.Media, null],
              [CompatibilityChecker.EAppTemplateType.Minimalist, null],
              [
                CompatibilityChecker.EAppTemplateType.Nearby,
                "This app requires a feature layer with pop-up enabled",
              ],
              [CompatibilityChecker.EAppTemplateType.Notify, null],
              [
                CompatibilityChecker.EAppTemplateType.Observer,
                ResourceResults.Webscene,
              ],
              ...
              [CompatibilityChecker.EAppTemplateType.Streamflow, null],
              [
                CompatibilityChecker.EAppTemplateType.ZoneLookup,
                "This app requires a feature layer with pop-up enabled",
              ],
            ].forEach((testInfo) => {
              assert.equal(result.get(testInfo[0]), testInfo[1], testInfo[0]);
            });
          });
        }
      );
      ...
      suite(
        "WebScene: https://catsqa.mapsdevext.arcgis.com/home/item.html?id=9c2abe9b33bd44fba4f6443ec67ef7cf",
        () => {
          test("checkAllTemplates", async () => {
            const result: Map<CompatibilityChecker.EAppTemplateType, string> =
              await compatibilityChecker.checkAllTemplates(
            ...
            [
              ...
              [
                CompatibilityChecker.EAppTemplateType.Media,
                ResourceResults.Webmap,
              ],
              [
                CompatibilityChecker.EAppTemplateType.Minimalist,
                ResourceResults.Webmap,
              ],
              [
                CompatibilityChecker.EAppTemplateType.Nearby,
              ...
              [
                CompatibilityChecker.EAppTemplateType.Notify,
                ResourceResults.Webmap,
              ],
              [CompatibilityChecker.EAppTemplateType.Observer, null],
              [CompatibilityChecker.EAppTemplateType.Portfolio, null],
              [
                CompatibilityChecker.EAppTemplateType.Reporter,
                ResourceResults.Webmap,
              ],
              [
                CompatibilityChecker.EAppTemplateType.Sidebar,
                ResourceResults.Webmap,
              ],
              [
                CompatibilityChecker.EAppTemplateType.Slider,
                ResourceResults.Webmap,
              ],
              [
                CompatibilityChecker.EAppTemplateType.Streamflow,
                ResourceResults.Webmap,
              ],
              [
                CompatibilityChecker.EAppTemplateType.ZoneLookup,
      ...
      suite("Group", () => {
        test("checkAllTemplates", async () => {
          const result: Map<CompatibilityChecker.EAppTemplateType, string> =
            await compatibilityChecker.checkAllTemplates("group");
          ...
          [
            ...
            [
              CompatibilityChecker.EAppTemplateType.Basic,
            ...
            [
              CompatibilityChecker.EAppTemplateType.Portfolio,
              ResourceResults.WebmapOrWebscene,
            ],
            [
              CompatibilityChecker.EAppTemplateType.Reporter,
